...
export default function PersonalData({ setNext, registerUser }) {
  const { data, setPersonalData } = useAuth();
  ...
  return (
    <div className="login">
      ...
      <div className="container__login">
        ...
        <h2>
          Registra tus datos corporales, estos nos van a servir para calcular{' '}
          <br /> tus requerimientos diarios y asi tener una experiencia
          personalizada
        </h2>
          ...
          {({ values, touched, errors }) => (
            <Form className="form__data">
              ...
              <div className="form__control-select">
                ...
                <Field
                  ...
                  options={[
                    {
                      value: 'sedentario',
                      label: 'Sedentario(Nada de actividad)',
                    },
                    {
                      value: 'poca',
                      label: 'Poca actividad(Entreno 1 vez por semana)',
                    },
                    {
                      value: 'media',
                      label: 'Actividad media(Entreno 2-4 veces por semana)',
                    },
                    {
                      value: 'alta',
                      label:
                        'Actividad alta(Entreno más de 5 veces por semana)',
                    },
                    {
                      value: 'superalta',
                      label: 'Actividad elite(Entreno 2 veces por dìa)',
                    },
                  ]}
                />
                <div className="control__box">
              ...
              <div className="form__control-sexo">
                <label
                  className={`label__sexo ${
                    values.sexo == 'hombre' ? 'checked' : ''
                  }`}
                >
                  <Field
                    type="radio"
